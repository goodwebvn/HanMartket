...
/* martket/view/template/localisation/subscription_status_form.twig */
class __TwigTemplate_e02b079a48a2ee281fda2a01c938317f extends Template
{
    ...
    <div class=\"card\">
      ...
      <div class=\"card-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
            ...
            yield "][name]\" value=\"";
            yield (((($_v0 = ($context["subscription_status"] ?? null)) && is_array($_v0) || $_v0 instanceof ArrayAccess ? ($_v0[CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 27)] ?? null) : null)) ? (CoreExtension::getAttribute($this->env, $this->source, (($_v1 = ($context["subscription_status"] ?? null)) && is_array($_v1) || $_v1 instanceof ArrayAccess ? ($_v1[CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 27)] ?? null) : null), "name", [], "any", false, false, false, 27)) : (""));
            yield "\" placeholder=\"";
            yield ($context["entry_name"] ?? null);
            yield "\" id=\"input-name-";
            yield CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 27);
        ...
        // line 33
        yield ($context["subscription_status_id"] ?? null);
        yield "\" id=\"input-subscription-status-id\"/>
        </form>
      </div>
    </div>
  </div>
...
";
    ...
    {
        return "martket/view/template/localisation/subscription_status_form.twig";
    }
...
{{ footer }}
", "martket/view/template/localisation/subscription_status_form.twig", "/var/www/html/martket/view/template/localisation/subscription_status_form.twig");
    }
}
